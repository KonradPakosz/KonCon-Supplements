...
Product.create!(
    ...
    description: %{'Creatine Monohydrate is the most widely used sports nutrition supplement in existence. As an example, it is estimated that over 90% of athletes at the 2012 Olympics supplemented with Creatine! 
    Why is Creatine so popular? Well, this is for good reason. Creatine is research proven to increase physical performance in successive bursts of short-term, high intensity exercise. This makes it the perfect supplement for all kinds of athletes, including: bodybuilders, powerlifters, footballers, rugby players, sprinters – and pretty much anyone participating in high intensity exercise.'},
    image_url: 'http://www.de-omairah.com/wp-content/uploads/2017/03/Sample.jpg',
    price: 9.99,
    category: 'Creatine')
Product.create!(
